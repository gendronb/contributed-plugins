...
<div class="slider-bar-control slider-reverse-control" ng-controller="ReverseSliderCtrl as ctrl">
    <md-button
        aria-label="{{ ctrl.isReverse ? 'plugins.dimensionSlider.bar.forward' : 'plugins.dimensionSlider.bar.reverse' | translate }}"
        class="md-icon-button primary"
        ng-click="ctrl.reverse()">
        <md-tooltip>{{ ctrl.isReverse ? 'plugins.dimensionSlider.bar.forward' : 'plugins.dimensionSlider.bar.reverse' | translate }}</md-tooltip>
